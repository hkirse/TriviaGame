// Page timer is set to 90 seconds
...
$(document).ready(function(){
	...
	// TimeOut page after 1:30 minute
	...
	// Window scroll to see the Seinfeld picture
	...
	function timeUp(){
		...
		else if(Q6 == "Licking toxic envelopes"){
			correctCount++;
		}
		else{
			wrongCount++;
